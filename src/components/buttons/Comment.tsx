...
const Comment: React.FC<CommentProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="bg-transparent hover:bg-hover active:bg-pressed active:scale-90 transition-all duration-200 ease-in-out grid place-items-center w-6 h-6 rounded-md"
    >
