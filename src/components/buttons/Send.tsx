...
const Send: React.FC = () => {
  return (
    <div className="bg-brand hover:scale-105 active:bg-pressed active:scale-90 transition-all duration-200 ease-in-out grid place-items-center w-[35px] h-[35px] rounded-full">
